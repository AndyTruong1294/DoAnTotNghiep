    ...
    <div class="layout">
        <div class="header">
            ...
            <div style="margin-left: auto; padding: 10px 20px;">
                Chào mừng, <?php echo isset($_SESSION['maDonVi']) ? $_SESSION['maDonVi'] : 'Chưa có mã'; ?> | <a href="<?php echo BASE_URL ?>DangNhap" class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Đăng xuất</a>
            </div>
        </div>
        ...
        <div class="menu">
            ...
            <hr>
            <a href="<?php echo BASE_URL ?>QuanLySuKien">
                <button type="button" class="btn" style="color: orange;">
                    <h5>Sự kiện</h5>
                </button>
            </a>
            <hr>
            <a href="<?php echo BASE_URL ?>QuanLyThanhVien">
                <button type="button" class="btn" style="color: orange;">
                    <h5>Thành viên</h5>
                </button>
            </a>
