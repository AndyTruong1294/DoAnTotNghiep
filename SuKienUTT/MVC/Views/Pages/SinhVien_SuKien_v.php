...
<body>
    <form action="<?php echo BASE_URL ?>SinhVien/timkiem" method="POST">
        <div>
            <div class="container">
                <div class="row row-cols-4">
                    ...
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="txtTenDonVi" id="floatingInput" placeholder="" value="<?php if(isset($data['tendonvi'])) echo $data['tendonvi'] ?>">
                            <label for="floatingInput">Đơn vị tổ chức</label>
                        </div>
                    </div>
                    <div class="col">
        ...
        <div class="table-box">
            <table class="table table-hover">
                ...
                <tbody>
                    <?php
                    if(isset($data['danhsachsukien'])&&mysqli_num_rows($data['danhsachsukien'])>0){
                        while($row=mysqli_fetch_assoc($data['danhsachsukien'])){
                            $orgDate = $row['ngay'];
                    ...
                    <tr>
                        ...
                        <td class="ev_name"><?php echo $row['tenDonViToChuc'] ?></td>
                        <td class="ev_name"><?php echo $row['diaDiem'] ?></td>
                        <td><?php echo $newDate ?></td>
                        <td><?php echo $newTime ?></td>
                        <td>
                            <a href="<?php echo BASE_URL ?>SinhVien/thongtinsukien/<?php echo $row['maSuKien'] ?>">Xem chi tiết</a>
                        </td>
                    </tr>
                    <?php
                        }
