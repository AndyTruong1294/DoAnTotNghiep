...
<body>
    <form action="<?php echo BASE_URL ?>QuanLySuKien/timkiem" method="POST">
        <div>
            <div class="container">
                ...
                <div class="row row-cols-2">
                        <div class="col">
                            <div class="d-grid gap-2">
                                <button class="btn btn-primary" type="submit" name="btnTim">Tìm kiếm sự kiện</button>
                            </div>
                        </div>
                        <div class="col">
                            <a href="<?php echo BASE_URL ?>QuanLySuKien/taomoi">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary" type="button">Tạo sự kiện mới</button>
                                </div>
                            </a>
                        </div>
                    </div> 
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo BASE_URL ?>QuanLySuKien/chitiet/<?php echo $row['maSuKien'] ?>">Xem chi tiết</a>
                        </td>
                    </tr>
                    <?php
                        }
